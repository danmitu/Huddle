...
public class DrawCode : NSObject {
    ...
    @objc dynamic public class func drawKebabIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 50, height: 150), resizing: ResizingBehavior = .aspectFit, isSelected: Bool = false) {// This code was generated by Trial version of PaintCode, therefore cannot be used for commercial purposes.
        // http://www.paintcodeapp.com
        ...
        //// Oval Drawing
        context.saveGState()
        context.translateBy(x: 12, y: 37)
        context.scaleBy(x: 0.5, y: 0.5)
        
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 0, y: -25, width: 50, height: 50))
        ...
        //// Oval 2 Drawing
        context.saveGState()
        context.translateBy(x: 12, y: 62)
        context.scaleBy(x: 0.5, y: 0.5)
        
        let oval2Path = UIBezierPath(ovalIn: CGRect(x: 0, y: 0, width: 50, height: 50))
        UIColor.gray.setFill()
        oval2Path.fill()
        ...
        //// Oval 3 Drawing
        context.saveGState()
        context.translateBy(x: 12, y: 87)
        context.scaleBy(x: 0.5, y: 0.5)
        
        let oval3Path = UIBezierPath(ovalIn: CGRect(x: 0, y: 25, width: 50, height: 50))
        UIColor.gray.setFill()
        oval3Path.fill()
    ...
    @objc dynamic public class func imageOfKebabIcon(isSelected: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 50, height: 150), false, 0)
        DrawCode.drawKebabIcon(isSelected: isSelected)
        
        let imageOfKebabIcon = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
        
        return imageOfKebabIcon
    }
